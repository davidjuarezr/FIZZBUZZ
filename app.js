...
const assignToFizzBuzzTrick = function (explorer) {
...
const explorersInNodeAndToFizzBuzzTrick = explorersInNode.map((explorer) => assignToFizzBuzzTrick(explorer));
console.log(explorersInNodeAndToFizzBuzzTrick)